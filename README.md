...
For now, only employees are transformed to one of the main characters if the conditions are right and luck is in your favor.

I'm also planning to add the companies featured in the series as your competitors, which might involve a hookup with another mod called 'Real Brands' or has me splitting the mod up in different parts. It's too early to tell, at least for me.
...
## Disclaimer
This is my first try at a mod for this game and you'll find the code is riddled with comments and tools to get started and to understand the inner workings. So use this to your advantage, should you be inclined to start modding for Startup Company as well.
